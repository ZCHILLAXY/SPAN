...
# For dataset dir
__C.DATA_DIR = '/home/zhuangyi/SiamVoxel/kitti/training/'
__C.CALIB_DIR = '/home/zhuangyi/SiamVoxel/kitti/training/calib'
...
if __C.TRACK_OBJ == 'Car':
    __C.TEMPLATE_Z_MIN = -2
    __C.TEMPLATE_Z_MAX = 2
    __C.TEMPLATE_Y_MIN = -3.2
    __C.TEMPLATE_Y_MAX = 3.2
...
# elif  __C.TRACK_OBJ == 'Truck' or __C.TRACK_OBJ == 'Tram':
#     __C.TEMPLATE_Z_MIN = -2
#     __C.TEMPLATE_Z_MAX = 2
#     __C.TEMPLATE_Y_MIN = -8
#     __C.TEMPLATE_Y_MAX = 8
#     __C.TEMPLATE_X_MIN = -8
#     __C.TEMPLATE_X_MAX = 8
#     __C.SCENE_Z_MIN = -2
#     __C.SCENE_Z_MAX = 2
#     __C.SCENE_Y_MIN = -12.8
#     __C.SCENE_Y_MAX = 12.8
#     __C.SCENE_X_MIN = -12.8
#     __C.SCENE_X_MAX = 12.8
#     __C.VOXEL_Z_SIZE = 4
...
#     __C.FEATURE_HEIGHT = int(__C.INPUT_HEIGHT / __C.FEATURE_RATIO) + 1
    ...
    __C.TEMPLATE_Z_MIN = -2
    __C.TEMPLATE_Z_MAX = 2
    __C.TEMPLATE_Y_MIN = -0.8
    __C.TEMPLATE_Y_MAX = 0.8
    __C.TEMPLATE_X_MIN = -0.8
    __C.TEMPLATE_X_MAX = 0.8
    __C.SCENE_Z_MIN = -2
    __C.SCENE_Z_MAX = 2
    __C.SCENE_Y_MIN = -1.28
    __C.SCENE_Y_MAX = 1.28
    __C.SCENE_X_MIN = -1.28
    __C.SCENE_X_MAX = 1.28
    __C.VOXEL_Z_SIZE = 4
    __C.VOXEL_Y_SIZE = 0.04
    __C.VOXEL_X_SIZE = 0.04
