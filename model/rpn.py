...
class MiddleAndRPNFeature(nn.Module):
    def __init__(self, alpha = 1.5, beta = 1, sigma = 3, training = True, name = ''):
        super(MiddleAndRPNFeature, self).__init__()

        self.middle_layer = nn.Sequential(ConvMD(3, 32, 16, 3, (2, 1, 1,), (1, 1, 1)),
                                          ConvMD(3, 16, 16, 3, (1, 1, 1), (0, 1, 1)),
                                          ConvMD(3, 16, 16, 3, (2, 1, 1), (1, 1, 1)))


        # if cfg.TRACK_OBJ == 'Car':
        ...
        #                                 ConvMD(2, 128, 128, 3, (1, 1), (1, 1)))
        #
        # self.deconv1 = Deconv2D(128, 256, 1, (1, 1), (0, 0))
        #
    ...
    def forward(self, inputs):
        ...
        inputs = inputs.view(batch_size, C, DEPTH, HEIGHT, WIDTH)  # (B, D, H, W, C) -> (B, C, D, H, W)
        ...
        temp_deconv1, temp_deconv2, temp_deconv3 = self.yolo(temp_conv)
        ...
        return temp_deconv1, temp_deconv2, temp_deconv3
